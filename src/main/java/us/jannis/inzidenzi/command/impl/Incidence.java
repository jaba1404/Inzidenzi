...
public class Incidence extends Command {
    ...
    public void execute(String[] args, MessageChannel messageChannel, Message message, Guild guild) {
        ...
        embedBuilder.addField(fixWindowsEncoding("Gesamtzahl der Fälle"), String.valueOf(districtResponse.getCases()), false);
        ...
        embedBuilder.addField(fixWindowsEncoding("Gesamtzahl der Todesfälle"), String.valueOf(districtResponse.getDeaths()), false);
